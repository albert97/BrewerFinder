        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <c:url var="registerSubmit" value="/register"/>
              <form:form class="user" method="POST" action="${registerSubmit}" modelAttribute="user">
                <input type="hidden" name="CSRF_TOKEN" value="${CSRF_TOKEN}"/>

                <div class="form-group">
                  <form:input type="text" class="form-control form-control-user" required="true"
                              path="role" name="role" id="role" placeholder="Role"/>
                    <%--                                    <form:option value="Brewer">Brewer</form:option>--%>
                    <%--                                    <form:option value="beerLover">Beer Lover</form:option>--%>

                </div>
                <div class="form-group row">
                  <form:input type="text" class="form-control form-control-user"
                  path="role" name="role" id="role" placeholder="customer"/>
